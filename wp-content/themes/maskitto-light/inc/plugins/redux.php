...
if (!class_exists('maskitto_light_Redux_Framework_config')) {
    ...
    class maskitto_light_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            $maskitto_light_new = 'http://jevelin.shufflehound.com/hello/';
            $maskitto_light_documentation = 'http://shufflehound.com/maskitto-light/';
            $maskitto_light_support = 'https://wordpress.org/support/theme/maskitto-light';
            $maskitto_light_support_twitter = 'https://www.twitter.com/theshufflehound';
            $maskitto_light_support_facebook = 'https://www.facebook.com/shufflehound';
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array( 
                        'id'       => 'opt-raw',
                        'type'     => 'raw',
                        'title'    => __("Don't miss our new theme - Jevelin!", 'maskitto-light'),
                        'desc'     => '
                        <p>'.__( '
                            - <b>9 headers</b> with top, left, right layouts<br />
                            - <b>40+</b> unique <b>elements</b> with multiple styles<br />
                            - built-in <b>social sharing</b> capability<br />
                            - <b>6+ blog</b> and <b>portfolio</b> layouts<br />
                            - built-in <b>Mega menu</b> support<br />
                            - <b>WooCommerce</b> and <b>Revolution slider</b> integration<br />
                            - and much <b>more!</b>', 'maskitto-light' ).'</p>
                        <a class="button button-primary button-new-theme" href="'.esc_url( $maskitto_light_new ).'" target="_blank">'.__( 'Explore Jevelin in our live demo', 'maskitto-light' ).'</a>',
                        'content'  => ''
                    ),
                    ...
                    array( 
                        'id'       => 'opt-raw',
                        'type'     => 'raw',
                        'title'    => __('Get latest news about our new themes in our social media', 'maskitto-light'),
                        'desc'     => '
                            <div class="sh-news-buttons">
                                <a class="button" href="'.esc_url( $maskitto_light_support_facebook ).'" target="_blank"><i class="el el-facebook"></i>'.__( 'Like Facebook', 'maskitto-light' ).'</a>
                                <a class="button" href="'.esc_url( $maskitto_light_support_twitter ).'" target="_blank"><i class="el el-twitter"></i>'.__( 'Follow Twitter', 'maskitto-light' ).'</a>
                            </div>',
                        'content'  => ''
                    ),
                    ...
                    array( 
                        'id'       => 'opt-raw',
                        'type'     => 'raw',
                        'title'    => __('Support', 'maskitto-light'),
                        'desc'     => 
                            __('If you are wondering how to setup this theme, then please visit our', 'maskitto-light').' <a href="'.esc_url( $maskitto_light_documentation ).'" target="_blank">'.__( 'documentation guide', 'maskitto-light' ).'</a>.<p style="font-size: 13px;">'.
                            __('If you need some help with this theme or you found a bug, then please visit our', 'maskitto-light').' <a href="'.esc_url( $maskitto_light_support ).'" target="_blank">'.__( 'support forum', 'maskitto-light' ).'</a>.</p>',
                        'content'  => ''
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'       => 'general-style',
                        'type'     => 'radio',
                        'title'    => __('General Style', 'maskitto-light'), 
                        'subtitle' => __('Choose global slideshow widget style', 'maskitto-light'),
                        'options'  => array(
                            '1' => 'Red and green demo style', 
                            '3' => 'Blue demo style', 
                        ),
                        'default' => '1'
                    ),
