...
<div class="grid_16 alpha">
    <div class="content">
        <div class="content-info">
            ...
            <h2><?php _e('Our Blog','toommorel-lite'); ?> </h2>
        </div>
        ...
        <?php if (have_posts()) while (have_posts()) : the_post(); ?>
                ...
                <div class="post single">
                    ...
                    <div class="dotted_line"></div>
                    <div class="post-meta"><?php _e('Posted by','toommorel-lite'); ?>
                        <?php the_author_posts_link() ?>
                        <?php _e('in','toommorel-lite'); ?>
                        <?php the_category(', '); ?>
                        <?php _e(', Followed with','toommorel-lite'); ?>
        <?php comments_popup_link('No Comments.', '1 Comment.', '% Comments.'); ?>
                    </div>
                    <div class="dotted_line"></div>
                        <?php the_content(); ?>
                     <?php wp_link_pages( array( 'before' => '<div class="clear"></div><div class="page-link"><span>' . __( 'Pages:', 'toommorel-lite' ) . '</span>', 'after' => '</div>' ) ); ?>
                    <div class="tags">
        <?php the_tags(__('Post Tagged with ','toommorel-lite'), ', ', ''); ?>
                    </div>
                    <div class="dotted_line"></div>
